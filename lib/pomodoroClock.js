...
const Clock = {
    ...
    start(sessionLength, breakLength) {
        ...
        $("#timer").click(() => {
            if (!this.interval) Clock.start();
        });

        this.interval = setInterval(() => {
            if ((self.sessionTime + self.breakTime) >= 0) {
                ...
                // TODO: make sure to reset sessionLength and breakLength to initial values,
                // so that counter will "reset"
            }
